use ms_manager_core::{
    ...
    manifest_sig_url_for_tag, manifest_url_for_tag, parse_manifest_json, parse_releases_api_json,
    public_key_b64_for_channel, stable_latest_manifest_url, stable_latest_sig_url,
    verify_manifest_sig_b64, Channel, Manifest, ManifestChannel, DIST_REPO_SLUG,
};
